/**
 * Bundled US zip code prefix → state lookup.
 *
 * Maps the first 3 digits of a US zip code to the state abbreviation.
 * This is based on USPS geographic region assignments and allows instant
 * zip-to-state resolution without external API calls.
 *
...
const ZIP3_TO_STATE: Record<string, string> = {
    ...
    // NY
    '005': 'NY', '100': 'NY', '101': 'NY', '102': 'NY', '103': 'NY', '104': 'NY',
...
/**
 * Look up the US state abbreviation for a given zip code.
 * Uses only the first 3 digits (USPS sectional center prefix).
